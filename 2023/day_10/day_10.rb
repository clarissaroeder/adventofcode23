...
class Map
  ...
  def replace_start_with_pipe
    connecting_tiles = tiles.select { |tile| start_tile.connecting_positions.include?(tile.position) }

    tile_1, tile_2 = connecting_tiles

    # WRONG
    #                   # below and right
    # start_pipe = if ((tile_1.row > start_tile.row) && (tile_2.column > start_tile.column)) ||
    #                      ((tile_2.row > start_tile.row) && (tile_1.column > start_tile.column))
    #                     "F"
    #                   # below and left
    #                   elsif ((tile_1.row > start_tile.row) && (tile_2.column < start_tile.column)) ||
    #                         ((tile_2.row > start_tile.row) && (tile_1.column < start_tile.column))
    #                     "7"
    #                   # below and above
    #                   elsif ((tile_1.row > start_tile.row) && (tile_2.row < start_tile.row)) ||
    #                         ((tile_1.row > start_tile.row) && (tile_2.row < start_tile.row))
    #                     "|"
    #                   # right and left
    #                   elsif ((tile_1.column > start_tile.column) && (tile_2.column < start_tile.column)) ||
    #                         ((tile_2.column > start_tile.column) && (tile_1.column < start_tile.column))
    #                     "-"
    #                   # right and above
    #                   elsif ((tile_1.column > start_tile.column) && (tile_2.row < start_tile.row)) ||
    #                         ((tile_2.column > start_tile.column) && (tile_1.row < start_tile.row))
    #                     "L"
    #                   # above and left
    #                   elsif ((tile_1.row < start_tile.row) && (tile_2.column < start_tile.column)) ||
    #                         ((tile_2.row < start_tile.row) && (tile_1.column < start_tile.column))
  ...
  def print_tiles
    ...
    # puts
    # if !expanded_tiles.nil?
    #   puts "Expanded tiles:"
    #   number_of_columns = expanded_tiles.last.column

    #   expanded_tiles.each do |tile|
    #     print tile.pipe
    #     if tile.column == number_of_columns
    #       puts
    #     end
